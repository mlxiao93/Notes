...
var LimitRequest = /*#__PURE__*/function () {
  function LimitRequest(limit) {
    _classCallCheck(this, LimitRequest);
  ...
  _createClass(LimitRequest, [{
    key: "execTask",
    value: function execTask() {
      var _this = this;
    ...
    value: function request(req) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this2.tasks.unshift(task);

        if (_this2.currentNum < _this2.limit) {
          _this2.execTask();
        }
      });
    }
...
var limitRequest = new LimitRequest(2);
var requests = Array(10).fill(null).map(function (v, i) {
  return function () {
    return new Promise(function (resolve, reject) {
      setTimeout(function () {
        resolve(i);
...
},{}]},{},["../../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","promise.js"], null)
//# sourceMappingURL=/promise.5a8638e0.js.map