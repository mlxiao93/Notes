...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"currying.js":[function(require,module,exports) {
function sum() {
  ...
  function res() {
    ...
    return sum.apply(void 0, args1.concat(args2));
  }

  res.toString = function () {
    return args1.reduce(function (acc, val) {
      return acc + val;
    }, 0);
  };
...
function curry(func) {
  return function curried() {
    ...
    if (args1.length >= func.length) {
      return func.apply(void 0, args1);
    } else {
      return function () {
        ...
        return curried.apply(void 0, args1.concat(args2));
      };
    }
  };
}

var twoPlus = curry(_twoPlus); // console.log(twoPlus(1, 2));
...
var getType = Object.prototype.toString.unCurrying(); // console.log(getType([]))
...
},{}]},{},["../../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","currying.js"], null)
//# sourceMappingURL=/currying.fafea908.js.map