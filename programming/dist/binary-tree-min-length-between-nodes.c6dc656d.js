...
var nodes = Array(12).fill(null).map(function (v, i) {
...
function getMinLength(root, p, q) {
  // 1. 先计算最近的共同祖先
  var closestParent = getClosestCommonParent(root, p, q); // 2. 计算祖先到p和q的路径长度，相加

  var pathP = getPath(closestParent, p);
  var pathQ = getPath(closestParent, q);
...
},{}]},{},["../../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","binary-tree-min-length-between-nodes.js"], null)
//# sourceMappingURL=/binary-tree-min-length-between-nodes.c6dc656d.js.map