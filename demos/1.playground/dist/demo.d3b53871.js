...
var findOrder = function findOrder(numCourses, prerequisites) {
  /**
   * 使用DFS
   * 从任意一门课程开始搜索
   * 
   ...
   */
  // 转为邻接表，便于搜索
  var adjList = Array(numCourses).fill().map(function (i) {
    return [];
  });

  var _iterator = _createForOfIteratorHelper(prerequisites),
      _step;
  ...
  var result = []; // 记录课程的搜索状态

  var visitMap = Array(numCourses).fill(-1);
  ...
  function visit(node) {
    ...
    var _iterator2 = _createForOfIteratorHelper(adjList[node]),
        _step2;
...
},{}]},{},["../../../../../.nvm/versions/node/v10.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","demo.js"], null)
